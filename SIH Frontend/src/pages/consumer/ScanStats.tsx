...
export const ScanStats = () => {
  ...
  const mockLocationData = [
    { name: 'Urban Areas', value: 65, color: 'hsl(var(--primary))' },
    { name: 'Suburban Areas', value: 25, color: 'hsl(var(--secondary))' },
    { name: 'Rural Areas', value: 10, color: 'hsl(var(--muted-foreground))' },
  ];
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">Scan Analytics</h1>
          <div className="flex items-center justify-center space-x-2">
            <QrCode className="h-6 w-6 text-foreground" />
            <span className="text-foreground text-lg">Batch #{batchId}</span>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <div className="text-2xl font-bold text-primary">{scanData.totalScans}</div>
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <div className="text-2xl font-bold text-primary">{scanData.uniqueScans}</div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-primary">Daily Scan Activity</CardTitle>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-primary">Recent Scan Activity</CardTitle>
